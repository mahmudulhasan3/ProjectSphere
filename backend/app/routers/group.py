...
from backend.app.services.semester_service import get_active_semester
...
def leave_group(
    ...
    if len(remaining_members) == 1:
        ...
        from backend.app.services.notification_service import notify_admins_group_at_risk
